...
public class Random_Vehicle {
    ...
    public Random_Vehicle(JTable vehiclesTable, Report_Generator report_generator) {
        ...
        report_generator.add_vehicle_text(vehicle_id);
        add_vehicle_to_table(vehiclesTable);
    }
